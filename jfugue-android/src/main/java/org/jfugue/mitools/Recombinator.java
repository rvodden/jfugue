...
public class Recombinator {
  ...
  public Recombinator put(int index, List<Object> things) {
    switch (index) {
      case 0:
        things0AsList = things;
        things0AsArray = null;
        break;
      case 1:
        things1AsList = things;
        things1AsArray = null;
        break;
      default:
  ...
  public Recombinator put(int index, Object[] things) {
    switch (index) {
      case 0:
        things0AsList = null;
        things0AsArray = things;
        break;
      case 1:
        things1AsList = null;
        things1AsArray = things;
        break;
      default:
        throw new IllegalArgumentException("Index to Recombinator must be either 0 or 1; provided value is " + index);
    }
  ...
  public Pattern recombine(String instructions, LoopBehavior option) {
    ...
    switch (option) {
      case LOOP_BOTH:
        return loopBoth(instructions);
      case LOOP_0_FIRST:
        return loop0(instructions);
      case LOOP_1_FIRST:
        return loop1(instructions);
      default:
        return null;
    }
  }
