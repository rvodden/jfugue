...
public class MidiParser extends Parser {
  ...
  private void parseMetaMessage(MetaMessage message, MidiEvent event) {
    switch (message.getType()) {
      case MidiDefaults.META_SEQUENCE_NUMBER:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_TEXT_EVENT:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_COPYRIGHT_NOTICE:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_SEQUENCE_NAME:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_INSTRUMENT_NAME:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_LYRIC:
        lyricParsed(message);
        fireHandledMidiEvent(event);
        break;
      case MidiDefaults.META_MARKER:
        markerParsed(message);
        fireHandledMidiEvent(event);
        break;
      case MidiDefaults.META_CUE_POINT:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_MIDI_CHANNEL_PREFIX:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_END_OF_TRACK:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_TEMPO:
        tempoChanged(message);
        fireHandledMidiEvent(event);
        break;
      case MidiDefaults.META_SMTPE_OFFSET:
        fireUnhandledMidiEvent(event);
        break;
      case MidiDefaults.META_TIMESIG:
        timeSigParsed(message);
        fireHandledMidiEvent(event);
        break;
      case MidiDefaults.META_KEYSIG:
        keySigParsed(message);
        fireHandledMidiEvent(event);
        break;
      case MidiDefaults.META_VENDOR:
        fireUnhandledMidiEvent(event);
        break;
      default:
        fireUnhandledMidiEvent(event);
